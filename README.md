...
* The latest public release is [r1.2](https://github.com/camaraproject/ApplicationEndpointDiscovery/releases/tag/r1.2), with the following API versions:
  * **application-endpoint-discovery 0.1.0**
  [[YAML]](https://github.com/camaraproject/ApplicationEndpointDiscovery/blob/r1.2/code/API_definitions/application-endpoint-discovery.yaml)  [[ReDoc]](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/camaraproject/ApplicationEndpointDiscovery/r1.2/code/API_definitions/application-endpoint-discovery.yaml&nocors)  [[Swagger]](https://camaraproject.github.io/swagger-ui/?url=https://raw.githubusercontent.com/camaraproject/ApplicationEndpointDiscovery/r1.2/code/API_definitions/application-endpoint-discovery.yaml)

* The latest public release is always available here: https://github.com/camaraproject/ApplicationEndpointDiscovery/releases/latest
* Other releases of this repository are available in https://github.com/camaraproject/ApplicationEndpointDiscovery/releases
* For changes see [CHANGELOG](https://github.com/camaraproject/ApplicationEndpointDiscovery/tree/main/CHANGELOG)

### Upcoming Release Preview

* Pre-release: [r2.1](https://github.com/camaraproject/ApplicationEndpointDiscovery/releases/tag/r2.1) (release candidate)
  * **application-endpoint-discovery 0.2.0-rc.1**
  [[YAML]](https://github.com/camaraproject/ApplicationEndpointDiscovery/blob/r2.1/code/API_definitions/application-endpoint-discovery.yaml)  [[ReDoc]](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/camaraproject/ApplicationEndpointDiscovery/r2.1/code/API_definitions/application-endpoint-discovery.yaml&nocors)  [[Swagger]](https://camaraproject.github.io/swagger-ui/?url=https://raw.githubusercontent.com/camaraproject/ApplicationEndpointDiscovery/r2.1/code/API_definitions/application-endpoint-discovery.yaml)
